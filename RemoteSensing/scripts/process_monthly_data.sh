...
###
# Process monthly data and save in temp_monthly collection.
#
# Parameters:
...
#
# The script will iterate all monthly data files,
# it will load the current file in a temp collection,
# dump the data with a new structure and with eventual processing,
# and finally load all processed monthly data into the temp_monthly collection.
###
...
span="std_date_span_month"

echo "=================================================="
echo "= process_monthly_data.sh"
echo "=================================================="
echo $$
echo "=================================================="
echo ""
process_monthly_data_start=$(date +%s)
...
process_monthly_data_end=$(date +%s)
elapsed=$((process_monthly_data_end-process_monthly_data_start))
echo "=================================================="
echo "= process_monthly_data.sh duration: $elapsed seconds"
echo "=================================================="
echo ""
