...
variable="env_climate_sma"

###
# Parameters.
###
collection="temp_ping"
query="${path}/DroughtObservatory/query/process.aql"

echo "--------------------------------------------------"
echo "- PROCESS SMA FILES"
echo "--------------------------------------------------"
start=$(date +%s)
...
do
	...
	echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
	echo ">>> PROCESS SMA/data/${name}.jsonl"
	echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
...
echo ""
echo "--------------------------------------------------"
echo "- PROCESS SMA FILES: $elapsed seconds"
echo "--------------------------------------------------"
echo ""
