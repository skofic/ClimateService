...
do
	...
	# Set parameters.
	###
	url="https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/DROUGHTOBS/Drought_Observatories_datasets/EDO_Daily_Maximum_Temperature/ver1-0-0/tpmax_m_euu_${year}0101_${year}1231_d.zip"
