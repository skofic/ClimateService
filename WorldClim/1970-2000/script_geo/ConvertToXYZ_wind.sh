...
###
# Convert wind speed maps to CSV.
###
...
echo "====================================================================="
echo "= Convert wind speed variables to CSV."
echo "====================================================================="
...
###
# Convert clipped wind speed variables to CSV format.
###
...
elapsed=$((end-start))
echo "--------------------------------------------------"
echo "1970-2000 convert_wind.sh"
