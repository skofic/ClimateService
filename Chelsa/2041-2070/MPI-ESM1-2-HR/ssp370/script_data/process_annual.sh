...
do
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (no transform)"
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (lookup Koppen Geiger 0, 1, 2)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (lookup Koppen Geiger 3)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (lookup Koppen Geiger 4)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (lookup Koppen Geiger 5)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (scale 0.1)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (scale 0.001)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
	...
	do
		...
		elapsed=$((end-start))
		echo "--------------------------------------------------"
		echo "2041-2070 process_annual.sh (scale 0.1 offset -273.15)"
		echo "Elapsed time: $elapsed seconds"
		echo "----------------------------------------"
	done
